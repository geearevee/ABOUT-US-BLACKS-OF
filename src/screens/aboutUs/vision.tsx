...
export default function Vision() {
  ...
  return (
    <div
      ref={sectionRef}
      className="py-36 min-h-[700px] relative before:content-[''] bg-cover bg-no-repeat max-[1145px]:bg-[length:100%_2000px] before:w-full before:h-full before:inset-0 before:bg-black before:opacity-50 before:absolute"
      style={{ backgroundImage: `url(${VisionImage})` }}
    >
      <div className="w-[min(90%,1440px)] mx-auto my-44 flex gap-64 max-[1145px]:gap-4 max-[1145px]:flex-col">
