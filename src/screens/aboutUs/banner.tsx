...
export default function Banner() {
  ...
  return (
    ...
    >
      ...
      <div className="flex text-white  pt-24  mx-auto min-h-screen w-[min(90%,1440px)] max-[940px]:flex-wrap">
        <div className="flex-[1_1_55%] pr-2 pt-24 relative max-[940px]:flex-[1_1_100%]">
          <div className="text-4xl font-normal relative leading-normal pt-20 w-[80%] max-[1390px]:w-[90%] max-[940px]:w-[70%] text-left mr-auto ml-0 max-[640px]:w-[90%] max-[500px]:mx-0 max-[500px]:w-full max-[500px]:text-3xl">
            Between creating and piloting drones and rising upto the challenges
            with them, we discovered <SlidingWords />
            <img
              className="absolute left-[120px] bottom-[-180px] max-[1240px]:hidden max-[940px]:hidden"
              src={ringSvg}
              alt=""
            />
          </div>
        ...
        <div className="flex-[1_1_40%] text-2xl self-end pb-20 px-4 max-[760px]:px-0 max-[940px]:flex-[1_1_100%] max-[640px]:mt-4 max-[500px]:mt-0">
          <p className="w-[80%] max-[940px]:w-[60%] text-left mr-0 ml-auto max-[760px]:w-full max-[760px]:pt-4 max-[760px]:ml-0 max-[500px]:text-xl">
