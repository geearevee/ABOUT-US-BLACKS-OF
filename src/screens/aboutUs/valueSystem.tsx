  ...
  return (
    <div className="bg-green py-32">
      <div className="w-[min(90%,1440px)] pb-20 pt-12 mx-auto text-white">
        ...
        <div className="flex justify-between mt-10 max-[1000px]:flex-wrap gap-2">
        ...
        <div className="flex flex-nowrap justify-between mt-24 max-[1000px]:flex-wrap max-[1000px]:gap-10">
          <div className="flex-[1_1_30%] max-[1000px]:flex-[1_1_100%] pr-10">
          ...
          <div className="flex-[1_1_30%] max-[1000px]:flex-[1_1_100%] px-10 border-x-1 max-[1000px]:border-none border-white/30 border-solid">
          ...
          <div className="flex-[1_1_30%] max-[1000px]:flex-[1_1_100%] pl-10">
