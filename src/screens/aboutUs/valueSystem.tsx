    ...
    <div className="bg-green py-24">
      <div className="w-[min(90%,1440px)] pb-20 pt-12 mx-auto text-white">
        ...
        <div className="flex justify-between mt-12 max-[750px]:flex-wrap gap-2">
          ...
          <p className="flex-[1_1_50%] pt-4 pl-32 text-[20px]">
            To ensure an undefeated journey to our vision, we turned to our
            morality. We found our core values and nurtured them.
          </p>
        </div>
        <div className="flex flex-nowrap justify-between mt-20 max-[750px]:flex-wrap max-[750px]:gap-10">
          ...
          <div className="flex-[1_1_30%] max-[750px]:flex-[1_1_100%] px-4 border-x-1 max-[750px]:border-none border-white/30 border-solid">
