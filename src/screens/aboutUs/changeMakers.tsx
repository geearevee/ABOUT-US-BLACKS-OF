    ...
    <div className="bg-white">
      <div className="w-[min(90%,1100px)] mx-auto flow-root pb-20">
        ...
        <div className="mt-14 relative h-max w-max mx-auto">
          <div className="flex rounded-xl w-[900px] w-max-[900px] max-[1000px]:w-[500px] max-[1000px]:w-max-[500px] max-[550px]:w-[400px] max-[550px]:w-max-[400px]  max-[500px]:w-[330px]  overflow-hidden flex-nowrap">
            <div
