  ...
  return (
    <div className="flex gap-28 justify-between w-full items-center relative  max-[1170px]:flex-wrap">
      ...
      <div className="flex  flex-[1_1_auto] max-[680px]:flex-[0_0_90%] h-full overflow-hidden text-white max-[1170px]:mx-auto">
        <div
          className="w-full min-w-full  pt-4 px-4 transition-transform ease-in-out duration-300"
          style={{ transform: `translateX(-${100 * year}%)` }}
        >
          <h1 className="text-[78px] max-[550px]:text-[48px] font-semibold">
            2016
          </h1>
          <p className="text-[36px] max-[550px]:text-[20px]">
        ...
        >
          ...
          <p className="text-[36px] max-[550px]:text-[20px] before:inline-block ">
            Raises Grant from{' '}
          </p>
          <p className="text-[36px] max-[550px]:text-[20px] before:inline-block before:content-[''] before:mx-2 before:mb-2 max-[550px]:before:mb-0 before:rounded-full before:bg-yellow before:h-3 before:w-3">
            a-idea
          </p>
          <p className="text-[36px] max-[550px]:text-[20px] before:inline-block before:content-[''] before:mx-2 before:mb-2 max-[550px]:before:mb-0 before:rounded-full before:bg-yellow before:h-3 before:w-3">
            BIRAC-BIG
