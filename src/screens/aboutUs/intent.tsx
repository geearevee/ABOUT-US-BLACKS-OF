  ...
  return (
    <div className="bg-white h-max pt-28">
      <div className="flex w-[min(90%,1440px)] mx-auto gap-10 max-[985px]:flex-wrap">
        <div className="flex-[1_1_50%] pr-28 max-[985px]:pr-0">
          ...
          <h2 className="pt-10 text-[48px] font-[600] font-medium">
          ...
          <div className="mt-10 pb-4 grid grid-rows-[max-content_max-content] grid-cols-[max-content_max-content] gap-x-16 max-[1070px]:gap-x-2 max-[410px]:gap-x-6 max-[410px]:grid-cols-[min-content_min-content]">
            <h2 className="font-[700] text-[52px] leading-[52px] text-[#22574D] ">
              19,000
            </h2>
            <h2 className="col-start-2 font-[700] text-[52px] leading-[52px] text-[#22574D] col-span-1">
              50,000
            </h2>
